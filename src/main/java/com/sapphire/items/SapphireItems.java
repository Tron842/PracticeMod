...
public class SapphireItems {
    ...
    public static void initItems() {
        ...
        helmetSapphire = new sapphireArmor(enumArmorMaterialSapphire, armorRenderIndex, 0).setUnlocalizedName("helmetSapphire").setCreativeTab(SapphireBlocks.sapphireTab);
        chestplateSapphire = new sapphireArmor(enumArmorMaterialSapphire, armorRenderIndex, 1).setUnlocalizedName("chestplateSapphire").setCreativeTab(SapphireBlocks.sapphireTab);
        legsSapphire = new sapphireArmor(enumArmorMaterialSapphire, armorRenderIndex, 2).setUnlocalizedName("legsSapphire").setCreativeTab(SapphireBlocks.sapphireTab);
        bootsSapphire = new sapphireArmor(enumArmorMaterialSapphire, armorRenderIndex, 3).setUnlocalizedName("bootsSapphire").setCreativeTab(SapphireBlocks.sapphireTab);
